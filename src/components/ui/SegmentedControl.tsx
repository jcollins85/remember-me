...
function SegmentedControlComponent<T extends string>({
  ...
  return (
    <LayoutGroup>
      <div
        className={`relative inline-flex rounded-full bg-[var(--color-card)]/90 backdrop-blur-lg overflow-hidden shadow-[0_8px_18px_rgba(15,23,42,0.07)] p-0.5 ${className}`}
      >
        {segments.map(seg => {
